...
const STEPS = [
  ...
  },
  {
    ...
    activeComponents: [C.HOST, C.MODEL],
    messageFlow: null,
    message: null,
    narration: "The host application initializes its core components: the chat UI, the model integration layer, and the MCP client manager. The model connection (to the Anthropic API) is separate from MCP — it's a standard API client.",
